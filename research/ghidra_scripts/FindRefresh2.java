...
public class FindRefresh2 extends GhidraScript {
    public void run() throws Exception {
        String[] targets = {"Refreshing token for UDN", "Refreshed token", "RefreshCredentialsForService", "SCIContentSession", "refreshToken"};
        for (String s : targets) {
            ...
            while (iter.hasNext()) {
                ...
                if (d.hasStringValue()) {
                    ...
                    if (s.equals(v)) { addr = d.getAddress(); break; }
                }
            }
